                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body text-center">
                                            <img src="{{ asset('images/' . $berita->url_gambar) }}" style="width: 800px; height: auto;" class="img-fluid">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi" class="form-control" rows="5" style="width: 545px;" required>{{ $berita->deskripsi }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
